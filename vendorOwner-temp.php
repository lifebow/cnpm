                        ...
                        <tbody>
                          <tr>
                            ...
                            <td><div class="form-check">
                                <input class="form-check-input" type="radio" name="gridRadios" id="not-sold-out" value="option1" checked>
                                <label class="form-check-label" for="gridRadios1">
                                  Còn
                                </label>
                              </div>
                              <div class="form-check">
                                <input class="form-check-input" type="radio" name="gridRadios" id="sold-out" value="option2">
                                <label class="form-check-label" for="gridRadios2">
                                    Hết
                                </label>
                              </div></td>
                              <!--delete mon an-->
                              <td><button type="button" class="btn btn-primary" data-toggle="modal" data-target="#delete">Xóa</button>
                              <div class="modal fade" id="delete" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                <div class="modal-dialog">
                                  <div class="modal-content">
                                    <div class="modal-header">
                                      <h5 class="modal-title" id="deleteNotice">Bạn muốn xóa món ăn không?</h5>
                                      <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                        <span aria-hidden="true">&times;</span>
                                      </button>
                                    </div>
                                    <div class="modal-footer">
										<form method="POST" action="delete-eating" id="button-delete-eating">
								  ...
								  <div class="modal-dialog">
									<div class="modal-content">
									  ...
									  <div class="modal-body">
										<form method="post" action="modify-menu.php" id="modify-eating" accept-charset="UTF-8"><input type="hidden" name="form_type" value="add-new-eating" /><input type="hidden" name="utf8" value="✓" />
									...
									<div class="modal-footer">
										<div class="submit">					
											<button name="save-modify" id="button-modify-eating" type="submit" class="btn btn-primary">
											  <span>
					...
					<script>
					  ...
					  // event.target will be the input element.
						var td = event.target.parentNode; 
						  ...
						  var description=tr.cells[3].innerHTML;
                    ...
                    <div class="modal fade" id="staticBackdrop" data-backdrop="static" data-keyboard="false" tabindex="-1" role="dialog" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <form method="post" action="add-menu.php" id="add-new-eating" accept-charset="UTF-8"><input type="hidden" name="form_type" value="add-new-eating" /><input type="hidden" name="utf8" value="✓" />
                                        <div  id="add-new-eating-form" >
                                          <fieldset id="new-eating" class="form-horizontal">
                                            <div class="form-group required">
                                              <label  class="control-label" for="name">Tên món ăn</label>
                                              <div class="col-sm-10">
                                                <input type="text" value="" name="eating[name]" id="name" placeholder="Tên món ăn"  class="form-control"  autofocus>
                    ...
                    <table class="table table-hover">
                        ...
                        <tbody>
                          <tr>
                            ...
                            <td>Nguyễn Văn A</td>
                            <td>0123456789</td>
                            <td>a.nguyenvan@gmail.com</td>
                            <td>Đầu bếp</td>
                            <!--delete info employee-->
                            <td><button type="button" class="btn btn-primary" data-toggle="modal" data-target="#delete-employee">Xóa</button>
                    ...
                    <div class="modal fade" id="staticBackdropThree" data-backdrop="static" data-keyboard="false" tabindex="-1" role="dialog" aria-labelledby="staticBackdropLabelThree" aria-hidden="true">
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <form method="post" action="add-menu.php" id="add-new-employee" accept-charset="UTF-8"><input type="hidden" name="form_type" value="add-new-employee" /><input type="hidden" name="utf8" value="✓" />
                                        ...
                                        <fieldset id="new-employee" class="form-horizontal">
                                            ...
                                            <div class="form-group required">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="radio" name="employee" id="cooker1" value="option1" checked>
                                                        <label class="form-check-label" for="cooker1">
                                                            Đầu bếp
                                                        </label>
                                                    </div>
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="radio" name="employee" id="ITer1" value="option1">
									...
									<div class="modal fade" id="modify-coupon" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
									  <div class="modal-dialog">
										<div class="modal-content">
										  ...
										  <div class="modal-body">
											<form method="post" action="modify-coupon.php" id="modify-coupon" accept-charset="UTF-8"><input type="hidden" name="form_type" value="modify-coupon" /><input type="hidden" name="utf8" value="✓" />
