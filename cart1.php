					...
					<table class="table-shopping-cart" id="table_item">
						...
						?>
								<tr class="table-row">
									...
									<td class="column-5"><?php echo $row['price'] * $num;$sum+=$row['price'] * $num; ?> VND</td>
								</tr>
						<?php }
						} ?>
							...
							<table class="table" id="table_coupon">
								...
								<tbody>
									...
									<th class="column-1"><?php echo $order; ?></th>
										<th class="column-2"><?php echo $row['coupon_id']; ?></th>
										<th class="column-3"><?php echo $row['value'];?> VND</th>
										<th class="column-4 p-l-70"><?php echo $row['end1']; ?></th>
										<th class="column-5"><?php echo $row['num']; ?></th>
									</tr>
								</tbody>
										<?php } ?>
							</table>
			...
			$("button#button-apply").click(function() {
				...
				$.ajax({
						...
						success: function(msg) {
							...
							amount.textContent=String(sum-discount)+"VND";
						},
						error: function() {
							alert("failure");
						}
